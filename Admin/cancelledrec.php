...
<html lang="en">
  <head>
    ...
    <title>Mariposa Farm Resort - Reservations Manager - Cancelled Records</title>
  ...
  <body>
                ...
                <table class="table table-hover border">
                  <thead>
                    <tr class="bg-dark text-light">
                      <th scope="col">Cancelled Booking ID</th>
    ...
    <script>
        ...
        function retrieve_cancelled(){

        let xhr = new XMLHttpRequest();
        xhr.open("POST", "ajax/cancelled_rec.php", true);
