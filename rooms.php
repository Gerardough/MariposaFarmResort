<?php
    require_once("../PHP_PROJECT_FINALE/Admin/essentials/func.php");
    userlogin();
?>
<html>
      <head>
            <title>MFR | Rooms</title>
...
@media only screen and (max-width:512px) {
  ...
  .offer2.wrapper {
    height: 170vh;
      ...
      <section>
            <div class="my-5 px-4">
                  <h3 class="fw-bold h-font text-center tc">ROOMS</h3>
                  ...
                  <div class="col-lg-12 col-md-12 px-4" id = "rooms-data">
                  ...
                  <?php 
                        ...
                        <div class="card mb-4 border-0 shadow">
                              <div class="row g-0 p-3 align-items-center">
                                    <div class="col-md-5 mb-lg-6 mb-md-0 mb-3">
                                    ...
                                    <h4 class="mb-4">₱ $rm_info[price] per night</h4>
                                    <a href="m10_quiz.php?id=$rm_info[rm_id]" class="btn btn-sm w-100 text-bg-success shadow-none mb-2">Book Room</a>
